...
# Sarcastic Serenity - Restart Development Server
# Double-click this file to restart the development server
...
echo -e "${PURPLE}🔄 Sarcastic Serenity - Restart Development Server${NC}"
echo -e "${CYAN}==================================================${NC}"
...
echo ""
echo -e "${BLUE}⏳ Waiting 3 seconds before starting new server...${NC}"
sleep 3
...
echo "  • Use 'stop-server.command' to stop any running servers"
