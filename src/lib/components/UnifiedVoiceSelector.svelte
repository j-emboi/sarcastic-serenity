          ...
          {#each characterVoices as voice, index}
            <div class="w-full flex-shrink-0 px-2">
              {#if selectedCharacterId === voice.id}
                <div 
                  class="relative group cursor-pointer transition-all duration-300 hover:scale-105 border-2 rounded-xl p-3 ring-2 ring-blue-500 bg-gray-800/50 border-blue-500 max-w-sm mx-auto"
                ...
                >
                  ...
                  <!-- Description -->
                  <p class="text-sm text-gray-300 mb-3 leading-relaxed">{voice.description}</p>
              ...
              {:else}
                <div 
                  class="relative group cursor-pointer transition-all duration-300 hover:scale-105 border-2 rounded-xl p-3 bg-gray-800/30 border-gray-700 max-w-sm mx-auto"
                  on:click={() => selectVoice(voice.id)}
                >
                  <!-- Voice Header -->
                  <div class="flex items-center space-x-2 mb-2">
